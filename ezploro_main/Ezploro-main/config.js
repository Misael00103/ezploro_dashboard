...
const normalizeUrl = (url) => {
  ...
  // Fix common URL malformation issues - but preserve https://
  return url.replace(/([^:]\/)\/+/g, "$1")
}

// Base URL for serving images - Arreglar el replace para que no corte el dominio
const baseImageUrl = BASE_URL.endsWith('/api') ? BASE_URL.slice(0, -4) : BASE_URL
export const BASE_URL_IMAGE = normalizeUrl(baseImageUrl)
...
console.log('🔧 Config Debug:', {
  ...
  BASE_URL_IMAGE,
  SOCKET_URL,
  API_URL_EVENTS: `${BASE_URL}/events`,
  'BASE_URL ends with /api': BASE_URL.endsWith('/api'),
  'Socket configured for': 'same server as API (port 3000)'
})
...
export const API_URL_EVENT_LIKES_BY_USER = `${BASE_URL}/events/event-likes/:user_id` // GET /api/events/event-likes/:user_id
export const API_URL_EVENT_LIKES_TOGGLE = `${BASE_URL}/events/event-likes/toggle` // POST /api/events/event-likes/toggle
export const API_URL_EVENT_LIKES_COUNT = `${BASE_URL}/events/event-likes/count/:event_id` // GET /api/events/event-likes/count/:event_id
...
export const API_URL_EVENT_SUBSCRIPTIONS_TOGGLE = `${BASE_URL}/events/event-subscriptions/toggle` // POST /api/events/event-subscriptions/toggle
...
export const API_URL_EVENT_SUBSCRIPTIONS_BY_USER = `${BASE_URL}/events/event-subscriptions/:user_id`
...
export const API_URL_EVENT_MESSAGES_USER_EVENT_CHATS = `${API_URL_EVENT_MESSAGES}/events/chat-list/:userId`
...
export const API_URL_COMMENTS_EVENT = `${BASE_URL}/events/:event_id/comments` // Alias para CommentsContext
...
export const API_URL_NOTIFICATIONS_READ = `${API_URL_NOTIFICATIONS}/:id/read` // Alias para compatibilidad
export const API_URL_NOTIFICATIONS_MARK_ALL_READ = `${API_URL_NOTIFICATIONS}/read-all`
export const API_URL_NOTIFICATIONS_READ_ALL = `${API_URL_NOTIFICATIONS}/read-all` // Alias para compatibilidad
